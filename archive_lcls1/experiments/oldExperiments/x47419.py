...
grid_filepath = '/cds/home/opr/xppopr/experiments/xppx47419/'
#target_x = FastMotor() # fake motors
#target_y = FastMotor()
target_x = IMS('XPP:USR:PRT:MMS:27', name='sam_x')
target_y = IMS('XPP:USR:PRT:MMS:28', name='sam_y')
...
#            self.diode_bias = MpodChannel('XPP:R39:MPD:CH:100', name='diode_bias')
        ...
        with safe_load('grid_x'):
            self.grid_x = Newport('XPP:USR:MMN:10', name='grid_x')
        with safe_load('grid_y'):
            self.grid_y = Newport('XPP:USR:MMN:09', name='grid_y')
    def show_CC(self):
